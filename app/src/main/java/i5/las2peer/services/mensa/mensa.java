...
public class mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "347", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-347/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "rating"),
  ...
  public Response getDishRatings(@PathParam("id") String id) {
    ...
    // rating
    boolean rating_condition = true;
    if(rating_condition) {
      JSONObject rating = new classes().new Dish Rating().toJSON();

      

      return Response.status(HttpURLConnection.HTTP_OK).entity(rating.toJSONString()).build();
    }
    // dish_not_found
